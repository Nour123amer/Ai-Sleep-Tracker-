      ...
      {analysisResult && "error" in analysisResult ? (
        ...
        <div className="min-h-75 flex items-center justify-center p-6">
          <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 text-center shadow-xl">
            ...
            {/* glow background */}
            <div className="absolute inset-0 rounded-2xl bg-linear-to-r from-red-500/10 via-orange-500/10 to-pink-500/10 blur-2xl" />
            ...
            <div className="relative">
              ...
              {/* retry button */}
              <button className="mt-5 px-4 py-2 rounded-xl bg-linear-to-r from-red-500 to-orange-400 text-white text-sm font-medium hover:opacity-90 transition">
                Retry
              </button>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto mt-10 p-6 rounded-2xl text-purple-600 shadow-2xl border border-teal-500/20">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className='flex gap-6 items-center'>
              ...
              <Button
                className='px-4 py-8 rounded-full bg-linear-to-r from-purple-600 via-pink-500 to-purple-600 text-white'
