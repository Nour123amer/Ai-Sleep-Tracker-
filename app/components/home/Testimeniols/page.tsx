...
export default function Testimeniols() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-50 to-white px-6 py-20 md:px-16">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {data.map((item, i) => (
          ...
          >
            {/* glow */}
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-100 to-pink-100 opacity-0 blur-xl transition group-hover:opacity-100"></div>
